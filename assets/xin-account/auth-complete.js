// Return page for a Xin Account browser sign-in in Tonale and XHelpers Pro.
// Adapted from XTimers/assets/flexible-timers/auth-complete.js: the same
// one-click handoff, with these apps' callbacks as the only destinations.
(function (root) {
  "use strict";

  // The callbacks the Tonale and XHelpers Pro return pages may hand a
  // sign-in response to: each app's production and development scheme.
  var allowedCallbacks = Object.freeze([
    "com.xintechllc.tonale.auth://callback",
    "com.xintechllc.tonale.auth.development://callback",
    "com.xintechllc.xhelperspro.auth://callback",
    "com.xintechllc.xhelperspro.auth.development://callback"
  ]);
  ...
  function start() {
    ...
    var appName = body.getAttribute("data-app-name") || "the app";
