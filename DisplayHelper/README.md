# DisplayHelper App Store Website

This folder/repository contains the public website for the App Store/free
edition of DisplayHelper.

- Product landing page: `index.html`
- App Store edition: `app-store.html`
- App Store privacy policy: `privacy.html`
